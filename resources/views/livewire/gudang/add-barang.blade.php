<div id="add-barang" class="modal fade h-modal  is-big " tabindex="-1" role="dialog" aria-hidden="true" wire:ignore.self>
                        ...
                        <div class="column is-4">
                            <div class="field is-autocomplete">
                                ...
                                <div class="control  @error('nama_barang.0') has-validation has-error @enderror">
                                    <input wire:model.defer='nama_barang.0' class="input is-primary-focus"
                        ...
                        @foreach ($inputs as $key => $value)
                            <div class="column is-4">
                                <div class="field">
                                    <label>Barang</label>
                                    <div
                                        class="control  @error('nama_barang.{{ $value }}') has-validation has-error @enderror">
                                        <input wire:model='nama_barang.{{ $value }}'
                                            class="input is-primary-focus" placeholder="Barang *" required>
                            ...
                            <div class="column is-2">
                                <div class="field">
                                    <label>Harga</label>
                                    <div
                                        class="control  @error('harga.{{ $value }}') has-validation has-error @enderror">
                                        <input type="number" wire:model='harga.{{ $value }}'
                                            class="input is-primary-focus" placeholder="Harga *" required>
                            ...
                            {{-- <div class="column is-2">
                                <div class="field">
                                    <label>Keuntungan(%)</label>
                                    <div
                                        class="control  @error('untung.{{ $value }}') has-validation has-error @enderror">
                                        <input type="number" wire:model='untung.{{ $value }}'
                                            class="input is-primary-focus" placeholder="Harga *" required>
