<div id="view-rinci1" class="modal fade h-modal is-large " tabindex="-1" role="dialog" aria-hidden="true" wire:ignore.self>
    <div class="modal-background h-modal-close "></div>
    <div class="modal-content">
        <div class="modal-card">
            <header class="modal-card-head">
                <h3>Rincian Pembelian Tanggal {{ $rinci->tanggal }}
            ...
            <div class="modal-card-body has-slimscroll">
                ...
                <table class="table is-hoverable is-fullwidth">
                    <tbody>
                        ...
                        @foreach ($rinci->pembelianRelasiDetail as $p)
                            <tr>
                                <td>{{ $p->detailRelasiBarang->nama_barang }}</td>
                                <td>Rp. {{ $p->harga }}</td>
                                <td>{{ $p->jumlah }}</td>
