<div id="add-user" class="modal fade h-modal " tabindex="-1" role="dialog" aria-hidden="true" wire:ignore.self>
                ...
                <form action="" wire:submit.prevent="save">
                    ...
                    <div class="columns is-multiline">
                        <div class="column is-12">
                            <div class="field">
                                ...
                                <div class="control has-icon @error('name') has-validation has-error @enderror">
                                    <input wire:model='name' class="input" placeholder="Nama Lengkap *">
                                    <div class="form-icon">
                        ...
                        <div class="column is-12">
                            <div class="field">
                                <label>Role</label>
                                <div class="control has-icon @error('role') has-validation has-error @enderror">

                                    <div class=" h-select">
                                        <select wire:ignore.self wire:model='role' class="select w-100"
                                            style="width:800px;">
