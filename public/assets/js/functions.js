...
function initSidebar() {
    $(".huro-hamburger").on("click", function () {
        if ($(this).hasClass("full-push")) {
            ...
            $(".nav-trigger .menu-toggle .icon-box-toggle").toggleClass(
                "active"
            ),
                $("#" + e).toggleClass("is-active"),
                $(".view-wrapper").toggleClass("is-pushed"),
                $(".main-sidebar, .sidebar-brand").hasClass("is-bordered")
                    ? $(".main-sidebar, .sidebar-brand").removeClass(
                          "is-bordered"
                      )
                    : $(".main-sidebar, .sidebar-brand").addClass(
                          "is-bordered"
                      ),
...
function initWebapp() {
    ...
    $(".centered-link-toggle").removeClass("is-active"),
        ...
        $(
            ".webapp-navbar .centered-link-search, #webapp-navbar-search-close"
        ).on("click", function () {
        ...
        $(".navbar-burger").on("click", function () {
            $(this).toggleClass("is-active"),
                $(".mobile-main-sidebar").hasClass("is-active")
                    ...
                    : $(".mobile-main-sidebar, .mobile-subsidebar").addClass(
                          "is-active"
                      );
        });
}
...
function adjustDropdowns() {
    $(".dropdown:not(.user-dropdown):not(.profile-dropdown)").each(function () {
        ...
        $(window).on("scroll", function () {
            $(".dropdown:not(.user-dropdown):not(.profile-dropdown)").each(
                function () {
                    var e = $(this);
        ...
        $(".combo-box .box-dropdown li").on("click", function (e) {
            ...
            $(this).hasClass("data-push")) &&
                ...
                $.when($("#quick-specs").append(l)).then(function () {
                    $("#quick-specs .added-spec .remove-spec").on(
                        "click",
                        function () {
            ...
            $(this).closest(".animated-checkbox").hasClass("is-checked")
                ...
                : ($(this).closest(".animated-checkbox").addClass("is-checked"),
                  e
                      ...
                      .addClass("is-opaque"),
                  setTimeout(function () {
                      e.closest(".animated-checkbox").removeClass(
                          "is-unchecked"
                      );
                  }, 150));
        });
                    ...
                    s.length &&
                        ...
                        0 === $(e + ":visible").length
                            ? ($("*[data-filter-hide]").addClass("is-hidden"),
                              $(".custom-text-filter-placeholder").removeClass(
                                  "is-hidden"
                              ))
                            : ($(".custom-text-filter-placeholder").addClass(
                                  "is-hidden"
                              ),
                              $("*[data-filter-hide]").removeClass(
                                  "is-hidden"
                              )));
                });
        });
...
function initPlayers() {
    if ($(".video-player").length)
        if ("development" === env) {
            ...
            Array.from(document.querySelectorAll(".bulkit-player")).map(
                function (e) {
                    return new Plyr(e);
                }
            );
