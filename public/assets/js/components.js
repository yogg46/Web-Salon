...
$(document).ready(function () {
        ...
        $(".toast-trigger").length &&
            ...
            $("#info-toast-demo").on("click", function () {
                notyf.open({
                    type: "info",
                    message:
                        "This is some useful information that you might need.",
                });
            }),
            ...
            $("#purple-toast-demo").on("click", function () {
                notyf.open({
                    type: "purple",
                    message:
                        "This is a nice looking purple toast notification.",
                });
            }),
            ...
            $("#orange-toast-demo").on("click", function () {
                notyf.open({
                    type: "orange",
                    message:
                        "This is a nice looking orange toast notification.",
                });
            }),
            $("#primary-toast-demo").on("click", function () {
                $("body").hasClass("is-dark")
                    ? notyf.open({
                          type: "accent",
                          message:
                              "Please be careful when driving back to home.",
                      })
                    : notyf.open({
                          type: "primary",
                          message:
    ...
    if (
        ...
        SUNEDITOR.create(
            document.getElementById("sun-editor") || "sun-editor",
            {
                width: "100%",
                height: 250,
    ...
    if ($("#sun-editor-balloon").length)
        SUNEDITOR.create(
            document.getElementById("sun-editor-balloon") ||
                "sun-editor-balloon",
            {
                width: "100%",
                height: 250,
    ...
    $("#alertify-demo-1").length &&
        ...
        $(".circle-chart-wrapper").length &&
            $(".circle-chart-wrapper").each(function () {
                ...
                e.find(".circle-chart__circle").attr(
                    "stroke-dasharray",
                    t + ",100"
                );
            }),
